...
define( 'VIKATA_VERSION', '1.0.0' );

if ( ! function_exists( 'vikata_setup' ) ) {
	add_action( 'after_setup_theme', 'vikata_setup' );
	/**
	 * Sets up theme defaults and registers support for various WordPress features.
	 *
	 */
	function vikata_setup() {
		// Make theme available for translation.
		load_theme_textdomain( 'vikata' );
		...
		register_nav_menus( array(
			'primary' => __( 'Primary Menu', 'vikata' ),
		) );

		/**
		 * Set the content width to something large
		 * We set a more accurate width in vikata_smart_content_width()
		 */
...
define('VIKATA_THEME_URL','https://wpkoi.com/vikata-wpkoi-wordpress-theme/');
define('VIKATA_WPKOI_AUTHOR_URL','https://wpkoi.com/');
define('VIKATA_WPKOI_SOCIAL_URL','https://www.facebook.com/wpkoithemes/');
define('VIKATA_WORDPRESS_REVIEW','https://wordpress.org/support/theme/vikata/reviews/?filter=5');
define('VIKATA_DOCUMENTATION','https://wpkoi.com/docs/');
define('VIKATA_FONT_AWESOME_LINK','https://fontawesome.com/icons');
