...
if ( ! function_exists( 'vikata_social_bar' ) ) {
	add_action( 'vikata_social_bar_action', 'vikata_social_bar' );
	function vikata_social_bar() {
		$socials_facebook_url  		=  vikata_get_setting( 'socials_facebook_url' );
		$socials_twitter_url   		=  vikata_get_setting( 'socials_twitter_url' );
		$socials_google_url    		=  vikata_get_setting( 'socials_google_url' );
		$socials_tumblr_url    		=  vikata_get_setting( 'socials_tumblr_url' );
		$socials_pinterest_url 		=  vikata_get_setting( 'socials_pinterest_url' );
		$socials_youtube_url   		=  vikata_get_setting( 'socials_youtube_url' );
		$socials_linkedin_url  		=  vikata_get_setting( 'socials_linkedin_url' );
		$socials_custom_icon_1  	=  vikata_get_setting( 'socials_custom_icon_1' );
		$socials_custom_icon_url_1  =  vikata_get_setting( 'socials_custom_icon_url_1' );
		$socials_custom_icon_2  	=  vikata_get_setting( 'socials_custom_icon_2' );
		$socials_custom_icon_url_2  =  vikata_get_setting( 'socials_custom_icon_url_2' );
		$socials_custom_icon_3  	=  vikata_get_setting( 'socials_custom_icon_3' );
		$socials_custom_icon_url_3  =  vikata_get_setting( 'socials_custom_icon_url_3' );
		$socials_mail_url     		=  vikata_get_setting( 'socials_mail_url' );
	?>
    <div class="vikata-social-bar">
    	<ul class="vikata-socials-list">
