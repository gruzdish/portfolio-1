...
$navigation_active = ( 'nav-left-sidebar' == vikata_get_navigation_location() ) ? true : false;
...
?>
<div id="left-sidebar" itemtype="https://schema.org/WPSideBar" itemscope="itemscope" <?php vikata_left_sidebar_class(); ?>>
	<div class="inside-left-sidebar">
		<?php
		/**
		 * vikata_before_left_sidebar_content hook.
		 *
		 */
		do_action( 'vikata_before_left_sidebar_content' );
		...
		/**
		 * vikata_after_left_sidebar_content hook.
		 *
		 */
		do_action( 'vikata_after_left_sidebar_content' );
		?>
